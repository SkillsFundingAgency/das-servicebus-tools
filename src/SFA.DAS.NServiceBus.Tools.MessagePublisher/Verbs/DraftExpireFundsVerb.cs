...
{
    [Option('m', "month", HelpText = "The date for which you wish to run expiry up to e.g. 5")]
    public int Month { get; set; }
    [Option('y', "year", HelpText = "The year for which you wish to run expiry up to e.g. 2018")] 
